function writeGeoJSON(res,region,loadType)
    ...
    fId = fopen(sprintf('../data/reliabilityFrontiers_%s_%s_%s.geojson',loadType,lower(region),strrep(num2str(res),'.','_')),'w');
    fprintf(fId,'{"type":"FeatureCollection","features":[');
    ...
    for i = 1:size(points,1)
        ...
        %s(end+1) = f;
        fprintf(fId,'{"type":"Feature","geometry":{"type":"Polygon","coordinates":%s},"properties":{"rf":{',...
